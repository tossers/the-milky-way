        ...
        return (
            <Card style={{position: 'relative', height: '600px'}} bodyStyle={{ padding: 0 }} noHovering={true}>
                ...
                <Row style={{width: '100%', position: 'absolute', bottom: '0'}}>
                    <Col span={8}><Button type={'primary'} className="marketBtn" style={{background: '#fff', color: '#DD5B64'}}>自选</Button></Col>
                    <Col span={8}><Button type={'primary'} className="marketBtn" style={{background: 'rgba(235, 239, 241, 0.38)', color: 'rgba(0,0,0,.65)'}}>黄河金三角</Button></Col>
                    <Col span={8}><Button type={'primary'} className="marketBtn" style={{background: 'rgba(235, 239, 241, 0.38)', color: 'rgba(0,0,0,.65)'}}>南交所</Button></Col>
                </Row>
            </Card>
        );
    }
